...
export const VARIANT_META: { full: VariantMeta;[k: string]: VariantMeta } = {
  ...
  goe: {
    title: 'Global Ontology Engine | GOE',
    description: "India's unified AI strategic intelligence graph. Real-time global intelligence dashboard with live news, markets, military tracking, infrastructure monitoring, and geopolitical data.",
    ...
    features: [
      'GOE Knowledge Graph',
      'India-centric default mapping',
      '6 domain strategic classification feed',
      'AI Intelligence briefs with domain tracking',
    ],
  },
};
