...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  ...
  goe: {
    geopolitics: [
      { name: 'Reuters Geopolitics', url: gn('geopolitics OR diplomacy OR summit when:1d') },
      { name: 'Foreign Policy', url: 'https://foreignpolicy.com/feed/' },
      { name: 'The Diplomat', url: 'https://thediplomat.com/feed/' },
    ...
    economics: [
      ...
      { name: 'WSJ Economy', url: 'https://feeds.content.dowjones.io/public/rss/RSSeconomy' },
    ],
    defence: [
      { name: 'Defense News', url: 'https://www.defensenews.com/arc/outboundfeeds/rss/?outputType=xml' },
      { name: 'Breaking Defense', url: 'https://breakingdefense.com/feed/' },
      { name: 'Janes', url: gn('site:janes.com when:7d') },
    ],
    technology: [
      { name: 'MIT Tech Review', url: 'https://www.technologyreview.com/feed/' },
    ...
    climate: [
      { name: 'Nature Climate', url: 'https://www.nature.com/nclimate.rss' },
